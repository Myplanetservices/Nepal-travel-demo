...
function BookingContent() {
  ...
  if (bookingSuccess) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center flex-1">
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          ...
          <a
            ...
            className="px-5 py-2.5 rounded-xl bg-white border border-[#7C8A96]/30 text-[#2D4A34] font-bold text-xs hover:bg-[#F5F3EF] flex items-center gap-2"
          >
  ...
  return (
    <>
      {/* Hero Header */}
      <section className="relative bg-[#1B2F22] text-[#F5F3EF] pt-32 pb-14 lg:pt-38 lg:pb-18 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center max-w-3xl">
          <div className="flex items-center justify-center gap-2 mb-3">
            <Badge className="bg-[#7FA05C] text-white border-none font-bold text-xs shadow-md">
              Himalayan Expeditions Reservation
            </Badge>
            <AnimatedTravelBadge
              icon="compass"
              label="GUARANTEED SLOTS"
          ...
          <p className="mt-3 text-xs sm:text-sm !text-white/95 leading-relaxed font-medium drop-shadow-md">
            Lock in your preferred 2026 dates with a 10% refundable deposit. Free date adjustments up to 30 days prior with direct Sherpa team coordination.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14 flex-1">
        <div className="mb-6 flex items-center justify-between">
          <Link
            href={`/tour/${selectedPackage.slug}`}
            className="inline-flex items-center gap-1.5 text-xs font-bold text-[#7C8A96] hover:text-[#2D4A34] transition-colors"
          >
            <ArrowLeft className="size-3.5" /> Back to {selectedPackage.title}
          </Link>
          <div className="text-xs text-[#7C8A96] font-medium">
            Selected Trip: <strong className="text-[#2D4A34]">{selectedPackage.title}</strong>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-[#7C8A96]/20 shadow-xs">
            <div className="flex items-center gap-3 mb-5">
              ...
              <AnimatedTravelBadge icon="mountain" label="TIERED DEPOSITS" animation="animate-gentle-pulse" size="size-4" className="ml-auto" />
            </div>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-[#7C8A96]/20 shadow-xs">
            <div className="flex items-center gap-3 mb-5">
              ...
              <AnimatedTravelBadge icon="passport" label="PASSPORT VERIFIED" animation="animate-float-gentle" size="size-4" className="ml-auto" />
            </div>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-[#7C8A96]/20 shadow-xs">
            <div className="flex items-center gap-3 mb-5">
              ...
              <AnimatedTravelBadge icon="hot-air-balloon" label="OPTIONAL UPGRADES" animation="animate-float-drift" size="size-4" className="ml-auto" />
            </div>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-[#7C8A96]/20 shadow-xs">
            <div className="flex items-center gap-3 mb-5">
              ...
              <AnimatedTravelBadge icon="compass" label="100% SECURE" animation="animate-gentle-pulse" size="size-4" className="ml-auto" />
            </div>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-[109px] space-y-6">
            <Card className="border border-[#7C8A96]/30 rounded-2xl bg-white shadow-xl overflow-hidden relative">
              {/* Animated visible 2D passport stamp */}
              <div className="absolute top-2 right-2 pointer-events-none z-10">
                <PassportStamp text="CONFIRMED ENTRY" date="2026" className="w-14 h-14 opacity-90 text-white animate-tilt-float" />
              </div>
