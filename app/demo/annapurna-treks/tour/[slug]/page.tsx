...
export default function TourDetailPage({
  ...
  // Calculate tier pricing based on pax
  ...
  return (
    <div className="w-full bg-[#F5F3EF]">
      ...
      <div className="bg-white border-b border-[#7C8A96]/20 py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between text-xs text-[#7C8A96]">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <span className="px-2 py-0.5 rounded bg-[#7FA05C]/20 text-[#2D4A34] font-bold text-[11px]">
      ...
      <div className="bg-[#2D4A34] text-[#F5F3EF] py-10 lg:py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-2 mb-3">
            ...
            <span className="text-xs text-white/80 font-medium ml-2 flex items-center gap-1">
              <Star className="size-3.5 fill-[#D9A23B] text-[#D9A23B]" />
              <strong>{pkg.rating}</strong> ({pkg.reviewsCount} verified reviews)
            </span>
          </div>

          <h1 className="font-heading font-extrabold text-3xl sm:text-4xl lg:text-5xl text-[#F5F3EF] tracking-tight leading-tight max-w-4xl">
            {pkg.title}
          </h1>

          <p className="mt-3 text-sm sm:text-base text-[#F5F3EF]/90 max-w-3xl leading-relaxed">
            {pkg.subtitle}
          </p>
        </div>
      </div>

      {/* Photo Gallery Grid (Access Nepal Style) */}
      ...
      <div className="w-full sticky top-[73px] sm:top-[77px] lg:top-[81px] z-30 bg-white border-b border-[#7C8A96]/20 shadow-xs mt-10 sm:mt-12">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-6 overflow-x-auto text-xs font-bold text-[#33322E] py-3.5 scrollbar-none">
            ...
            <Link
              href={`/demo/annapurna-treks/booking?package=${pkg.slug}`}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-12">
            {/* Key Facts Matrix Grid (Access Nepal 6-tile style) */}
            <div className="bg-white rounded-2xl p-6 border border-[#7C8A96]/20 shadow-xs">
              <h3 className="font-heading font-extrabold text-base text-[#2D4A34] mb-4">
                Trip Key Facts
              </h3>
            ...
            <section id="overview" className="bg-white rounded-2xl p-6 sm:p-8 border border-[#7C8A96]/20 shadow-xs">
              <h2 className="font-heading font-extrabold text-2xl text-[#2D4A34] mb-4">
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {isExpanded ? (
                          <ChevronUp className="size-4 text-[#7C8A96]" />
                        ) : (
            ...
            <section id="includes" className="bg-white rounded-2xl p-6 sm:p-8 border border-[#7C8A96]/20 shadow-xs">
              <h2 className="font-heading font-extrabold text-2xl text-[#2D4A34] mb-6">
            ...
            <section id="departures" className="bg-white rounded-2xl p-6 sm:p-8 border border-[#7C8A96]/20 shadow-xs">
              <h2 className="font-heading font-extrabold text-2xl text-[#2D4A34] mb-2">
                    ...
                    {pkg.tierPricing.map((tier, i) => (
                      <tr key={i} className="hover:bg-[#F5F3EF]/60 transition-colors">
                        ...
                        <td className="p-3 text-right">
                          <Link
                            href={`/demo/annapurna-treks/booking?package=${pkg.slug}&pax=${i === 0 ? 1 : i === 1 ? 2 : 4}`}
                ...
                {pkg.departures.map((dep, idx) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Link
                        href={`/demo/annapurna-treks/booking?package=${pkg.slug}&departure=${encodeURIComponent(dep.date)}`}
          ...
          {/* RIGHT COLUMN: Sticky Booking & Calculation Widget (Access Nepal Style) */}
          <div className="lg:col-span-1">
            <div className="sticky top-[165px] space-y-6">
              <Card className="border border-[#7C8A96]/30 rounded-2xl bg-white shadow-xl overflow-hidden">
                ...
                <CardContent className="p-5 space-y-5">
                  ...
                  <div className="space-y-2.5">
                    <Link
                      href={`/demo/annapurna-treks/booking?package=${pkg.slug}&pax=${selectedPax}`}
              ...
              {/* Direct WhatsApp Box */}
              <div className="bg-white p-5 rounded-2xl border border-[#7C8A96]/20 text-center shadow-sm">
                ...
                <p className="text-[11px] text-[#7C8A96] mb-3">
                  Talk with our senior Sherpa guide directly on WhatsApp.
                </p>
                <a
                  href={`https://wa.me/9779800000000?text=Hi%20Annapurna%20Treks,%20I'm%20asking%20about%20the%20${encodeURIComponent(pkg.title)}`}
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold text-xs transition-colors shadow-xs"
                >
                  <MessageCircle className="size-3.5 fill-white text-[#25D366]" />
